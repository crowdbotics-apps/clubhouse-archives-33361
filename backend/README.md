...
## Project Structure
    ...
    ├── clubhouse_archives_33361  # Django project configurations
...
1. Clone this repo and `cd clubhouse_archives_33361`
...
2. Clone this repo and `cd clubhouse_archives_33361`
